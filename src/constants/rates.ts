...
export const DEFAULT_UNIT_COST_RATES: UnitCostRates = {
  ...
  insulationFiberglassBattPerSf: { material: 0.85, labor: 0.55 },
  insulationMineralWoolBattPerSf: { material: 1.25, labor: 0.75 },
  insulationClosedCellWallPerBf: { material: 1.01, labor: 0.54 },
  insulationClosedCellFloorPerBf: { material: 0.93, labor: 0.50 },
  insulationClosedCellRoofPerBf: { material: 0.85, labor: 0.45 },
  insulationOpenCellFoamPerBf: { material: 0.45, labor: 0.25 },
  insulationBlownCellulosePerSf: { material: 1.15, labor: 0.65 },
  insulationSoundBattPerSf: { material: 0.65, labor: 0.45 },
  insulationFiberglassFloorBattPerSf: { material: 1.10, labor: 0.60 },
  ...
  doorBifoldSinglePerUnit: { material: 110.0, labor: 75.0 },
  doorBifoldDoublePerUnit: { material: 190.0, labor: 110.0 },
  doorPatioSliderPerUnit: { material: 750.0, labor: 400.0 },
  doorCasedOpeningPerUnit: { material: 45.0, labor: 45.0 },
